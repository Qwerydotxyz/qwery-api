// src/queries/letsbonkTopGraduating.query.js

/**
 * Build GraphQL query for top 100 about to graduate LetsBonk.fun tokens
 * @param {number} limit - Number of tokens to fetch (default: 100)
 * @param {number} minutesAgo - Time window in minutes (default: 5)
 * @returns {string} - GraphQL query string
 */
const buildLetsBonkTopGraduatingQuery = (limit = 100, minutesAgo = 5) => {
  return `
    {
      Solana {
        DEXPools(
...
module.exports = {
  buildLetsBonkTopGraduatingQuery
};
