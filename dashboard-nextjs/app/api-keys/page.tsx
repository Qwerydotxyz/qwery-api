    ...
    return (
      <div className="min-h-screen bg-white dark:bg-black flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-neutral-400 text-lg font-medium">Loading API keys...</p>
          <p className="text-gray-500 dark:text-neutral-500 text-sm mt-2">Connecting to wallet...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen h-full bg-white dark:bg-black flex flex-col">
      ...
      <nav className="bg-white dark:bg-black border-b border-gray-100 dark:border-neutral-800 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-4 sm:space-x-8">
              ...
              <div className="hidden lg:flex space-x-2 xl:space-x-4">
                <Link
                  href="/dashboard"
                  className="px-3 py-2 rounded-lg text-gray-700 dark:text-neutral-400 hover:bg-gray-50 dark:hover:bg-neutral-900 transition-colors"
                >
                  Dashboard
                </Link>
                <Link
                  href="/api-keys"
                  className="px-3 py-2 rounded-lg text-orange-600 dark:text-orange-400 bg-orange-50 dark:bg-orange-900/30 font-semibold"
                >
                  API Keys
                </Link>
                <Link
            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
              <span className="hidden sm:inline text-xs sm:text-sm md:text-base text-gray-700 dark:text-neutral-400 font-medium truncate max-w-[100px] sm:max-w-[150px] md:max-w-none">{user?.name}</span>
              <button
                onClick={handleLogout}
                className="hidden sm:block px-3 sm:px-4 py-1.5 sm:py-2 bg-gray-100 dark:bg-neutral-900 text-gray-700 dark:text-neutral-400 rounded-lg hover:bg-gray-200 dark:hover:bg-neutral-800 transition-colors text-xs sm:text-sm"
              >
                Logout
              </button>
              {/* Mobile menu button */}
              <button
                ...
                className="lg:hidden p-2 rounded-lg text-gray-700 dark:text-neutral-400 hover:bg-gray-100 dark:hover:bg-neutral-900 transition-colors"
              >
          ...
          {/* Mobile menu */}
          {mobileMenuOpen && (
            <div className="lg:hidden py-4 border-t border-gray-100 dark:border-neutral-800">
              <div className="flex flex-col space-y-2">
                ...
                <div className="pt-2 border-t border-gray-100 dark:border-neutral-800">
                  <p className="px-3 py-2 text-sm text-gray-600 dark:text-neutral-500">{user?.name}</p>
                  <button
                    onClick={() => {
                      setMobileMenuOpen(false);
                      handleLogout();
                    }}
                    className="w-full text-left px-3 py-2 rounded-lg text-gray-700 dark:text-neutral-400 hover:bg-gray-50 dark:hover:bg-neutral-900 transition-colors"
                  >
                    Logout
                  </button>
                </div>
      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 pb-20 sm:pb-32 w-full">
        ...
        <div className="mb-6 sm:mb-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-2">API Keys</h2>
            <p className="text-sm sm:text-base text-gray-600 dark:text-neutral-500">Manage your API keys for accessing the Qwery API</p>
          </div>
          <button
        ...
        {error && (
          <div className="mb-6 p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg">
            ...
            <button
              onClick={() => fetchData()}
              className="mt-2 px-4 py-2 text-sm bg-red-100 dark:bg-red-900/40 text-red-700 dark:text-red-400 rounded-lg hover:bg-red-200 dark:hover:bg-red-900/60 transition-colors"
            >
              Try Again
            </button>
          </div>
        ...
        {newlyCreatedKey && (
          <div className="mb-6 p-4 sm:p-6 bg-orange-50 dark:bg-orange-900/20 border-2 border-orange-500 dark:border-orange-600 rounded-xl shadow-lg">
            <div className="flex flex-col sm:flex-row items-start gap-4">
              ...
              <div className="flex-1 w-full">
                <h3 className="text-base sm:text-lg font-bold text-gray-900 dark:text-white mb-2">🎉 Your New API Key (Save This Now!)</h3>
                <p className="text-xs sm:text-sm text-gray-700 dark:text-neutral-400 mb-4">
                ...
                <div className="flex flex-col sm:flex-row items-stretch gap-2 mb-4">
                  <code className="flex-1 px-3 sm:px-4 py-2 sm:py-3 bg-white dark:bg-black border-2 border-orange-300 dark:border-orange-600 rounded-lg text-xs sm:text-sm font-mono text-gray-900 dark:text-white break-all overflow-x-auto">
                    {newlyCreatedKey}
                  </code>
                  <button
                    onClick={() => {
                ...
                <button
                  ...
                  className="text-xs sm:text-sm text-orange-600 dark:text-orange-400 hover:text-orange-800 dark:hover:text-orange-300 underline"
                >
        ...
        {/* Create Form */}
        {showCreateForm && (
          <div className="bg-white dark:bg-black rounded-xl shadow-sm p-6 border border-gray-100 dark:border-neutral-800 mb-8">
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Create New API Key</h3>
            <form onSubmit={handleCreateKey} className="space-y-4">
              <div>
                <label htmlFor="keyName" className="block text-sm font-medium text-gray-700 dark:text-neutral-400 mb-2">
                  Key Name
                </label>
                <input
                  id="keyName"
                  ...
                  className="w-full px-4 py-3 border border-gray-300 dark:border-neutral-700 bg-white dark:bg-neutral-900 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-200 text-gray-900 dark:text-white placeholder:text-gray-500 dark:placeholder:text-gray-400"
                  placeholder="e.g., Production API Key"
                />
                <p className="text-xs text-gray-500 dark:text-neutral-500 mt-1">Give your API key a descriptive name</p>
              </div>
              <button
                type="submit"
                disabled={creating}
        ...
        {/* API Keys List */}
        {apiKeys.length === 0 ? (
          <div className="bg-white dark:bg-black rounded-xl shadow-sm p-12 border border-gray-100 dark:border-neutral-800 text-center">
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">No API Keys Yet</h3>
            <p className="text-gray-600 dark:text-neutral-500 mb-6">Create your first API key to start using the Qwery API</p>
            <button
          ...
          <div className="space-y-4">
            {apiKeys.map((apiKey, index) => (
              <div
                key={apiKey.id}
                className="bg-white dark:bg-black rounded-xl shadow-sm p-4 sm:p-6 border border-gray-100 dark:border-neutral-800"
              >
                <div className="flex flex-col sm:flex-row justify-between items-start gap-4">
                  <div className="flex-1 w-full">
                    <div className="flex flex-wrap items-center gap-2 mb-2">
                      <h4 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white">{apiKey.name}</h4>
                      {apiKey.key.length > 20 ? (
                        ...
                        <span className="px-2 py-1 bg-gray-200 dark:bg-neutral-900 text-gray-600 dark:text-neutral-500 text-xs font-semibold rounded">
                          Prefix Only
                        </span>
                      )}
                    </div>
                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center space-y-2 sm:space-y-0 sm:space-x-2 mb-3">
                      <code className="px-3 py-2 bg-gray-100 dark:bg-neutral-900 rounded-lg text-xs sm:text-sm font-mono text-gray-700 dark:text-neutral-400 flex-1 break-all overflow-x-auto">
                        {apiKey.key}
                      </code>
                      <button
                        onClick={() => handleCopyKey(apiKey.key)}
                        className="px-4 py-2 bg-orange-100 dark:bg-orange-900/30 text-orange-600 dark:text-orange-400 rounded-lg hover:bg-orange-200 dark:hover:bg-orange-900/50 transition-colors flex-shrink-0 flex items-center justify-center gap-2"
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-6 space-y-1 sm:space-y-0 text-xs sm:text-sm text-gray-600 dark:text-neutral-500">
                      <span>
                  ...
                  <button
                    ...
                    className="ml-4 px-4 py-2 bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 rounded-lg hover:bg-red-100 dark:hover:bg-red-900/40 transition-colors"
        ...
        <div className="mt-8 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-6">
          <div className="flex items-start space-x-4">
            ...
            <div>
              <h4 className="font-semibold text-gray-900 dark:text-white mb-2">How API Keys Work</h4>
              <ul className="text-gray-700 dark:text-neutral-400 text-sm space-y-2 list-disc list-inside">
                <li>
                ...
                <li>
                  All API keys start with <code className="bg-gray-200 dark:bg-neutral-900 px-2 py-1 rounded">qwery_</code> prefix
                </li>
                <li>
                  Include your API key in requests using the header: <code className="bg-gray-200 dark:bg-neutral-900 px-2 py-1 rounded">X-API-Key: YOUR_KEY</code>
                </li>
                <li>
