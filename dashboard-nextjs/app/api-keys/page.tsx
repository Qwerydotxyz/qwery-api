    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400 text-lg font-medium">Loading API keys...</p>
    ...
    <div className="min-h-screen h-full bg-black flex flex-col">
      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 pb-20 sm:pb-32 w-full">
        ...
        <div className="mb-6 sm:mb-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-2">API Keys</h2>
            <p className="text-sm sm:text-base text-gray-400">Manage your API keys for accessing the Qwery API</p>
          </div>
          <button
        ...
        {newlyCreatedKey && (
          <div className="mb-6 p-4 sm:p-6 bg-orange-500/10 border-2 border-orange-500 dark:border-orange-600 rounded-xl shadow-lg">
            <div className="flex flex-col sm:flex-row items-start gap-4">
              <div className="flex-shrink-0">
                <svg className="w-6 h-6 sm:w-8 sm:h-8 text-orange-600 text-orange-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                </svg>
              </div>
              <div className="flex-1 w-full">
                <h3 className="text-base sm:text-lg font-bold text-white mb-2">🎉 Your New API Key (Save This Now!)</h3>
                ...
                <div className="flex flex-col sm:flex-row items-stretch gap-2 mb-4">
                  <code className="flex-1 px-3 sm:px-4 py-2 sm:py-3 bg-black border-2 border-orange-600 rounded-lg text-xs sm:text-sm font-mono text-white break-all overflow-x-auto">
                    {newlyCreatedKey}
                  </code>
                  <button
                    onClick={() => {
                ...
                <button
                  ...
                  className="text-xs sm:text-sm text-orange-600 text-orange-400 hover:text-orange-800 hover:text-orange-300 underline"
                >
            ...
            <form onSubmit={handleCreateKey} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-700 bg-black rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-200 text-white placeholder:text-gray-500 placeholder:text-gray-400"
                  placeholder="e.g., Production API Key"
                />
                <p className="text-xs text-gray-500 text-gray-500 mt-1">Give your API key a descriptive name</p>
              </div>
              <button
                type="submit"
                disabled={creating}
        ...
        {/* API Keys List */}
        {apiKeys.length === 0 ? (
          <div className="bg-black rounded-xl shadow-sm p-12 border border-gray-800 text-center">
            <h3 className="text-xl font-semibold text-white mb-2">No API Keys Yet</h3>
            <p className="text-gray-400 mb-6">Create your first API key to start using the Qwery API</p>
            <button
          ...
          <div className="space-y-4">
            {apiKeys.map((apiKey, index) => (
              <div
                key={apiKey.id}
                className="bg-black rounded-xl shadow-sm p-4 sm:p-6 border border-gray-800"
              >
                <div className="flex flex-col sm:flex-row justify-between items-start gap-4">
                  <div className="flex-1 w-full">
                    <div className="flex flex-wrap items-center gap-2 mb-2">
                      <h4 className="text-base sm:text-lg font-semibold text-white">{apiKey.name}</h4>
                      {apiKey.key.length > 20 ? (
                        ...
                        <span className="px-2 py-1 bg-gray-200 dark:bg-neutral-900 text-gray-400 text-xs font-semibold rounded">
                          Prefix Only
                        </span>
                      )}
                    </div>
                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center space-y-2 sm:space-y-0 sm:space-x-2 mb-3">
                      <code className="px-3 py-2 bg-gray-100 dark:bg-neutral-900 rounded-lg text-xs sm:text-sm font-mono text-gray-300 flex-1 break-all overflow-x-auto">
                        {apiKey.key}
                      </code>
                      <button
                        onClick={() => handleCopyKey(apiKey.key)}
                        className="px-4 py-2 bg-orange-100 dark:bg-orange-900/30 text-orange-600 text-orange-400 rounded-lg hover:bg-orange-200 dark:hover:bg-orange-900/50 transition-colors flex-shrink-0 flex items-center justify-center gap-2"
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-6 space-y-1 sm:space-y-0 text-xs sm:text-sm text-gray-400">
                      <span>
        ...
        <div className="mt-8 bg-black border border-gray-800 rounded-xl p-6">
          <div className="flex items-start space-x-4">
            ...
            <div>
              <h4 className="font-semibold text-white mb-2">How API Keys Work</h4>
